...
def create_followup_mission(customer, report_text, original_topic):
    try:
        ...
        🔥 STEP 1: หาวันที่นัดหมาย (Target Date)
        - เจอ "พรุ่งนี้" -> ใช้ {tomorrow_str}
        - เจอ "วัน...หน้า" -> ดูใน Reference Dates
        - เจอวันที่ชัดเจน -> ใช้ d/m/yy
        - ไม่เจอเลย -> ใช้ {next_month_str}
        
        🔥 STEP 2: จัดรูปแบบ Output (Strict Rules)
        1. **Topic**: ต้องมีวันที่นำหน้า เพื่อให้ระบบจัดเรียงได้
