...
def generate_talking_points(customer_name, mission_df):
    try:
        ...
        prompt = f"""
        บทบาทของคุณ: คุณคือ "เสนาธิการฝ่ายขาย" (Strategic Sales Planner) ที่ฉลาดและเน้นผลลัพธ์
        
        สถานการณ์: เซลล์กำลังจะไปเยี่ยมลูกค้าชื่อ: "{customer_name}"
        
        เป้าหมายสำคัญ (Mission) ที่เซลล์ต้องไปล้วงข้อมูลมาให้ได้ คือ:
        {tasks_text}
        
        คำสั่ง:
        ช่วยคิดบทพูดให้เซลล์ โดยอิงตาม "เป้าหมาย" ข้างบนนี้เท่านั้น (ห้ามแนะนำเรื่องทั่วไปที่ไม่เกี่ยวกับเป้าหมาย)
        
        สิ่งที่ต้องการ (Output):
        1. 🧊 Ice Breaker (1 ประโยค): ประโยคเปิดที่เนียนๆ เพื่อโยงเข้าสู่เรื่องงาน (ไม่เอาแบบ สวัสดีครับ ผมมาจากบริษัท... มันเชย)
        2. 🎯 Questions (3 ข้อ): คำถามจิตวิทยาหรือคำถามปลายเปิด ที่จะหลอกถามข้อมูลตาม "เป้าหมาย" ได้แนบเนียน
        
        สไตล์ภาษา: ภาษาพูดของนักธุรกิจไทย, ดูเป็นมืออาชีพ, ไม่เหมือนหุ่นยนต์
        """
